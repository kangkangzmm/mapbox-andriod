...
import com.yinglan.scrolllayout.demo.adapter.PhotoListAdapter;
...
//                mCursor.close();
    ...
    private static Uri getUriForFile(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context.getApplicationContext(), " com.yinglan.scrolllayout.demo.fileprovider", file);
        } else {
