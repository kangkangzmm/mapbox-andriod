...
import com.yinglan.scrolllayout.demo.viewpager.ListviewSearchAdapter;
                                ...
                                public void onResponse(String response, int id) {
                                    try {
                                        ...
                                        for (int i = 0; i < jsonarray.length(); i++) {
                                            ...
                                            dataList.add(jsonObj.getString("location")+",name:"+jsonObj.getString("name"));
                                            ListviewSearchAdapter adapter = new ListviewSearchAdapter(context,dataList);
