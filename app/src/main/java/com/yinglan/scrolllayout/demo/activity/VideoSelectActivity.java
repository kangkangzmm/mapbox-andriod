...
import com.yinglan.scrolllayout.demo.adapter.VideoListAdapter;
import com.yinglan.scrolllayout.demo.adapter.decoration.ThreeGridDecoration;
...
import com.yinglan.scrolllayout.demo.net.ApiInterface;
import com.yinglan.scrolllayout.demo.upload.ProgressRequestBody;
import com.yinglan.scrolllayout.demo.util.SizeUtils;
import com.yinglan.scrolllayout.demo.util.SystemUtil;
import com.yinglan.scrolllayout.demo.util.VideoFileUtils;
import com.yinglan.scrolllayout.demo.util.permission.KbPermission;
import com.yinglan.scrolllayout.demo.view.KbWithWordsCircleProgressBar;
import com.yinglan.scrolllayout.demo.view.SquareRelativeLayout;
...
//                mVideoBg.setImageBitmap(mVideoAdapter.getCheckPosition().getThumb());
    ...
    private void setListener() {
        mVideoAdapter.setPhotoAlbumListener(new com.yinglan.scrolllayout.demo.listener.PhotoAlbumListener<Topic>() {
            @Override
