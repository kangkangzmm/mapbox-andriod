...
import com.yinglan.scrolllayout.demo.core.ui.user.UserListViewModel;
import com.yinglan.scrolllayout.demo.core.voip.CallSingleActivity;
...
public class UserListFragment extends Fragment {
    ...
    private List<com.dds.core.ui.user.UserBean> datas;
    ...
    private class UserAdapter extends RecyclerView.Adapter<Holder> {
        ...
        public void onBindViewHolder(@NonNull Holder holder, int position) {
            com.dds.core.ui.user.UserBean userBean = datas.get(position);
            holder.text.setText(userBean.getNickName());
            if (AppVdeo.getInstance().getUsername().equals(userBean.getUserId())) {
