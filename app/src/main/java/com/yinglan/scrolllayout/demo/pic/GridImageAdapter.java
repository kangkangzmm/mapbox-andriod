package com.yinglan.scrolllayout.demo.pic;
...
//            File file = new File(media.getPath());
            ...
            OkHttpUtils.get().url(url)
                    ...
                    .addParams("query", "何母桥").build().execute(new StringCallback() {
                @Override
...
//            Log.d("imagePath", media.getPath());
////            File file = new File(media.getPath());
//            RequestBody image = RequestBody.create(MediaType.parse("image/jpg"), file);
//            RequestBody requestBody = new MultipartBody.Builder()
//                    .setType(MultipartBody.FORM)
//                    .addFormDataPart("file", media.getPath(), image)
//                    .build();
//            Request request = new Request.Builder()
//                    .url("http://kangkangtk.gnway.cc/attachment/upload")
//                    .post(requestBody)
//                    .build();
//            try {
//
