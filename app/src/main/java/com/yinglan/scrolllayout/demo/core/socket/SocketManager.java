package com.yinglan.scrolllayout.demo.core.socket;
...
public class SocketManager implements IEvent {
    ...
    public void onInvite(String room, boolean audioOnly, String inviteId, String userList) {
        ...
        intent.setComponent(new ComponentName(AppVdeo.getInstance().getPackageName(), VoipReceiver.class.getName()));
        // 发送广播
        AppVdeo.getInstance().sendBroadcast(intent);
