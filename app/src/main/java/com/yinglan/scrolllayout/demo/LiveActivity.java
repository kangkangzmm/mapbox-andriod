...
import com.yinglan.scrolllayout.demo.utils.LiveUI;
import com.yinglan.scrolllayout.demo.utils.StatusBarUtils;
...
//    private String rtmpUrl = "rtmp://ossrs.net/" + StatusBarUtils.getRandomAlphaString(3) + '/' + StatusBarUtils.getRandomAlphaDigitString(5);
    ...
    private String rtmpUrl = "rtmp://10.0.2.2:1935/live/stream";
