...
public class ListviewSearchAdapter extends BaseAdapter {
    ...
    public ListviewSearchAdapter(Context context,List<String> dataList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = View.inflate(mContext, R.layout.itemsearch_listview, null);
            viewholder = new ListviewAdapter.ViewHolder(convertView);
        ...
        viewholder.imageView.setImageResource(R.drawable.dj);
