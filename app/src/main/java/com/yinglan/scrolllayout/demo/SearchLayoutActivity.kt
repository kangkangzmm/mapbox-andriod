...
//                    ContextCompat.getDrawable(this@SearchLayoutActivity, R.drawable.shape_circle_select)
//                } else if (index == 2) {
//                    ContextCompat.getDrawable(this@SearchLayoutActivity, R.drawable.shape_circle_ordinary)
//                } else {
//                    ContextCompat.getDrawable(this@SearchLayoutActivity, R.drawable.shape_circle_normal)
//                }
