package com.yinglan.scrolllayout.demo.core;
...
import com.yinglan.scrolllayout.demo.core.voip.Consts;
import com.yinglan.scrolllayout.demo.core.voip.VoipReceiver;

/**
 * 主界面
 */
public class RtcMainActivity extends RtcBaseActivity implements IUserState {
...
//        viop.putExtra("msgId", intent.getLongExtra("msgId", 0));
        ...
        viop.setComponent(new ComponentName(AppVdeo.getInstance().getPackageName(), VoipReceiver.class.getName()));
        sendBroadcast(viop);
    }
